...
const Sidebar = ({
  ...
  // Filter users by username or phone number
      ...
      <div className="sidebar-chats">
        {sortedUsers.map((u) => {
          ...
          return (
            <div
              key={u._id}
              className={`chat-item ${selectedUser?._id === u._id ? "active" : ""}`}
            ...
            >
              ...
              <div className="chat-info">
                <div className="chat-info-top">
                  ...
                  {lastMsg && <span className="chat-time">{formatSidebarTime(lastMsg.createdAt)}</span>}
                </div>
                <div className="chat-preview">
                  {isTyping ? (
                    ...
                    <span className="last-message">
                      {lastMsg.isMine && <span className="you-prefix">You: </span>}
        ...
        {sortedUsers.length === 0 && searchQuery && (
          <div className="no-users">No match found for "{searchQuery}"</div>
        )}
